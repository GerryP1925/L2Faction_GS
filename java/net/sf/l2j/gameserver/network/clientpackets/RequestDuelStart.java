...
public final class RequestDuelStart extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			player.sendMessage("You may not duel while participating in an event.");
			return;
		}
		if (EventManager.getInstance().getActiveEvent().getParticipant(target) != null)
		{
			player.sendMessage("You may not duel someone who is participating in an event.");
			return;
		}
