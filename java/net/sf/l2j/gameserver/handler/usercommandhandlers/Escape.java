...
public class Escape implements IUserCommandHandler
{
	...
	{
		if (player.isInOlympiadMode() || player.isInObserverMode() || player.isInJail() || player.isInsideZone(ZoneId.BOSS))
		{
		...
		{
			player.sendMessage("You need to select a faction in order to return to town.");
			return;
		}
