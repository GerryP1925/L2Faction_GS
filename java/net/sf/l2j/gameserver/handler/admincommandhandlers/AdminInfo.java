...
public class AdminInfo implements IAdminCommandHandler
{
	...
	public static void sendGeneralInfos(Npc npc, NpcHtmlMessage html)
	{
		...
		html.replace("%siegablehall%", "none");
		
		html.replace("%shop%", (npc instanceof Merchant ? "<button value=\"Shop\" action=\"bypass -h admin_info shop\" width=65 height=19 back=\"L2UI_ch3.smallbutton2_over\" fore=\"L2UI_ch3.smallbutton2\">" : ""));
	}
