...
public class CastleMagician extends Folk
{
	...
	{
		if (clanLeader.isAlikeDead() || clanLeader.isOperating() || clanLeader.isRooted() || clanLeader.isInCombat() || clanLeader.isInOlympiadMode() || clanLeader.isInObserverMode() || clanLeader.isInsideZone(ZoneId.NO_SUMMON_FRIEND))
		{
