...
public final class Config
{
	...
	/** Faction Npcs */
	public static int FACTION_ONE_NPC;
	public static int FACTION_TWO_NPC;
	
	/** Faction Colors */
	public static int FACTION_ONE_COLOR;
	public static int FACTION_TWO_COLOR;
	
	/** Custom skill duration */
	public static ArrayList<IntIntHolder> CUSTOM_SKILL_DURATION;
	
	/** Buffer buff ids */
	public static ArrayList<Integer> BUFFER_BUFF_IDS;
	...
	private static final void loadCustom()
	{
		...
		FACTION_ONE_NPC = custom.getProperty("FactionOneNpc", 0);
		FACTION_TWO_NPC = custom.getProperty("FactionTwoNpc", 0);
		
		FACTION_ONE_COLOR = Integer.decode("0x"+custom.getProperty("FactionOneColor", "00FF00"));
		FACTION_TWO_COLOR = Integer.decode("0x"+custom.getProperty("FactionTwoColor", "FF0000"));
		
		CUSTOM_SKILL_DURATION = new ArrayList<>();
		String csd = custom.getProperty("CustomSkillDuration", "");
		String[] csdSplit = csd.split(";");
		for (String csdData : csdSplit)
		{
			String[] csdDataSplit = csdData.split(",");
			CUSTOM_SKILL_DURATION.add(new IntIntHolder(Integer.parseInt(csdDataSplit[0]), Integer.parseInt(csdDataSplit[1])));
		}
		
		BUFFER_BUFF_IDS = new ArrayList<>();
		String bbi = custom.getProperty("BufferBuffIds", "");
		String[] bbiSplit = bbi.split(",");
		for (String bbiData : bbiSplit)
			BUFFER_BUFF_IDS.add(Integer.parseInt(bbiData));
	}
